...
#### 1.2.3.1. Using an Existing Boolean Function
...
#### 1.2.3.2. Using a Function That Returns an AssertionResult
...
#### 1.2.3.3. Using a Predicate-Formatter
...
### 1.2.4. Floating-Point Comparison

See [Floating-Point Comparison](reference/assertions.md#floating-point) in the
Assertions Reference.

#### 1.2.4.1. Floating-Point Predicate-Format Functions
...
## 1.4. Teaching googletest How to Print Your Values
...
### 1.5.1. How to Write a Death Test
...
### 1.5.3. Regular Expression Syntax
...
## 1.6. Using Assertions in Sub-routines
...
### 1.6.1. Adding Traces to Assertions
...
### 1.6.2. Propagating Fatal Failures
...
#### 1.6.2.1. Asserting on Subroutines with an exception
...
#### 1.6.2.2. Asserting on Subroutines
...
#### 1.6.2.3. Checking for Failures in the Current Test
...
## 1.7. Logging Additional Information
...
## 1.8. Sharing Resources Between Tests in the Same Test Suite
...
## 1.9. Global Set-Up and Tear-Down
...
## 1.10. Value-Parameterized Tests
...
### 1.10.1. How to Write Value-Parameterized Tests
...
### 1.10.2. Creating Value-Parameterized Abstract Tests
...
### 1.10.3. Specifying Names for Value-Parameterized Test Parameters
...
## 1.15. Registering tests programmatically
...
```
## 1.16. Getting the Current Test's Name
...
## 1.17. Extending googletest by Handling Test Events
...
### 1.17.1. Defining Event Listeners
...
### 1.17.3. Generating Failures in Listeners
...
## 1.18. Running Test Programs: Advanced Options
...
### 1.18.1. Selecting Tests

#### 1.18.1.1. Listing Test Names
...
#### 1.18.1.2. Running a Subset of the Tests
...
#### 1.18.1.3. Stop test execution upon first failure
...
#### 1.18.1.4. Temporarily Disabling Tests
...
#### 1.18.1.5. Temporarily Enabling Disabled Tests
...
### 1.18.4. Controlling Test Output

#### 1.18.4.1. Colored Terminal Output
...
#### 1.18.4.2. Suppressing test passes

By default, googletest prints 1 line of output for each test, indicating if it
passed or failed. To show only test failures, run the test program with
`--gtest_brief=1`, or set the GTEST_BRIEF environment variable to `1`.

#### 1.18.4.3. Suppressing the Elapsed Time

By default, googletest prints the time it takes to run each test. To disable
that, run the test program with the `--gtest_print_time=0` command line flag, or
set the GTEST_PRINT_TIME environment variable to `0`.

#### 1.18.4.4. Suppressing UTF-8 Text Output
...
#### 1.18.4.5. Generating an XML Report
...
#### 1.18.4.6. Generating a JSON Report
...
### 1.18.5. Controlling How Failures Are Reported

#### 1.18.5.1. Detecting Test Premature Exit
...
#### 1.18.5.2. Turning Assertion Failures into Break-Points
...
#### 1.18.5.3. Disabling Catching Test-Thrown Exceptions
